...
args = {'image': 'image/ocr_a_reference.png', 'template': 'image/template.png'}

print(predict_card, template)
print("__________")
...
thresh = cv2.threshold(gradX, 0, 255,
    cv2.THRESH_BINARY | cv2.THRESH_OTSU)[1] #自动寻找合适的阈值
